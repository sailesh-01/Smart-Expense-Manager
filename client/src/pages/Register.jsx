          ...
          <div className={`rounded-[2rem] p-10 relative overflow-hidden backdrop-blur-xl border shadow-2xl ${
            ...
            <div className="relative z-10">
              <div className="mb-10 text-center lg:text-left">
                ...
                <p className="text-base text-[var(--text-secondary)]">Sign up to manage your precision assets.</p>
              </div>
              ...
              <div className="mt-10 pt-8 border-t border-[var(--border-color)]/20 text-center">
                <p className="text-sm text-[var(--text-secondary)]">
                  ...
                  <Link to="/login" className="text-[#00dbe7] font-bold hover:underline underline-offset-4 transition-all">
                    Sign In
                  </Link>
                </p>
              </div>
