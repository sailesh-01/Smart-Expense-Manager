...
const Login = () => {
  ...
  return (
    <div
      className={`flex-grow flex items-center justify-center w-full ${darkMode
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-6">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center relative">
          ...
          <div className="mt-8 text-center space-y-2">
            <h2 className="text-3xl font-bold tracking-tight text-[#00dbe7]">ExpensiQ</h2>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className={`rounded-[2rem] p-10 relative overflow-hidden backdrop-blur-xl border shadow-2xl ${darkMode
                ...
                <div className="space-y-2 group">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className={`w-full bg-transparent border-t-0 border-x-0 border-b-2 pl-8 py-2 text-base text-[var(--text-primary)] transition-all duration-300 focus:outline-none focus:ring-0 ${darkMode ? "border-[#849495]/30 focus:border-[#00dbe7] focus:shadow-[0_4px_12px_-4px_rgba(0,219,231,0.3)] placeholder-[#b9cacb]/40"
